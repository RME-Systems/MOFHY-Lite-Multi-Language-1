        ...
        <div class="container-fluid">
		    ...
		    <li class="nav-item nav-height dropdown with-arrow">
		      ...
		      <div class="dropdown-menu dropdown-menu-right" aria-labelledby="nav-link-dropdown-toggle">
		        <a href="<?php echo $AreaInfo['area_url'];?>myprofile.php" class="dropdown-item">Perfil</a>
		        <a href="<?php echo $AreaInfo['area_url'];?>mysettings.php" class="dropdown-item">Ajustes</a>
