<div class="container-fluid">
	<div class="card py-20">
		<div class="d-flex justify-content-between align-items-center ">
			<p class="m-0"><b>Mi Perfil</b></p>
			<a href="<?php echo $AreaInfo['area_url'];?>index.php" class="btn btn-danger btn-sm"><i class="fa fa-backward"></i> Volver</a>
		</div><hr>
		<div class="row">
			<div class="col-md-6">
				<h6 class="mb-0"><b>Primer Nombre:</b> <?php echo $ClientInfo['hosting_client_fname'];?></h6>
			</div>
			<div class="col-md-6">
				<h6 class="mb-0"><b>Apellido:</b> <?php echo $ClientInfo['hosting_client_lname'];?></h6>
			</div>
			<div class="col-md-6">
				<h6 class="mb-0"><b>Dirección de Email:</b> <?php echo $ClientInfo['hosting_client_email'];?></h6>
			</div>
			<div class="col-md-6">
				<h6 class="mb-0"><b>Numero de Telefono:</b> <?php echo $ClientInfo['hosting_client_phone'];?></h6>
			</div>

			<div class="col-md-6">
				<h6 class="mb-0"><b>Dirección de Domicilio:</b> <?php echo $ClientInfo['hosting_client_address'];?></h6>
			</div>
			<div class="col-md-6">
				<h6 class="mb-0"><b>Compañía:</b> <?php echo $ClientInfo['hosting_client_company'];?></h6>
			</div>
			<div class="col-md-6">
				<h6 class="mb-0"><b>País:</b> <?php 
					$countries = array(
			...
			<div class="col-md-6">
				<h6 class="mb-0"><b>Ciudad:</b> <?php echo $ClientInfo['hosting_client_city'];?></h6>
			</div>
			<div class="col-md-6">
				<h6 class="mb-0"><b>Codigo Postal:</b> <?php echo $ClientInfo['hosting_client_pcode'];?></h6>
			</div>
			<div class="col-md-6">
				<h6 class="mb-0"><b>Dirección IP:</b> <?php echo UserInfo::get_ip();?></h6>
			</div>
			<div class="col-md-6">
				<h6 class="mb-0"><b>Tipo de Dispositivo:</b> <?php echo UserInfo::get_device();?></h6>
			</div>
			<div class="col-md-6">
				<h6 class="mb-0"><b>Sistema Operativo del Dispositivo:</b> <?php echo UserInfo::get_os();?></h6>
			</div>
			<div class="col-md-6">
				<h6 class="mb-0"><b>Navegador Web:</b> <?php echo UserInfo::get_browser();?></h6>
			</div>
			<div class="col-md-12">
				<a href="mysettings.php" class="btn m5t btn-sm btn-primary">Actualizar Perfil</a>
				<a href="https://en.gravatar.com/" target="_blank" class="btn m5t btn-sm btn-secondary">Actualizar Imagen</a>
			</div>
		</div>
	</div>
</div>
