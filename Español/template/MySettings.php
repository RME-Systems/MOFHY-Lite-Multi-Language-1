		...
		<div class="d-flex justify-content-between align-items-center px-5">
		  ...
		  <form action="function/MySettings.php" method="post">
			<div class="row">
				...
				<div class="col-md-6">
					<div class="mb-10 px-10">
						<label class="form-label required">Nombre de la Compañía</label>
				...
				<div class="col-md-6">
					<div class="mb-10 px-10">
						<label class="form-label required">Nombre de País</label>
						...
						array("name"=>"Zimbabwe", "code"=>"ZW")
							...
							foreach($Country as $State){
								...
								elseif($State['code']=='NULL'){
									echo '<option value="NULL" disabled="disabled" selected="selected">Seleccione su País</option>';
								}
								else{
				...
				<div class="col-md-6">
					<div class="mb-10 px-10">
						<label class="form-label required">Nombre de Ciudad</label>
				...
				<div class="col-md-12">
					<div class="mb-10 px-10">
						<button name="submit" class="btn btn-sm btn-primary">Actualizar Perfil</button>
		...
		<form class="row" action="function/MyPassword.php" method="post" onsubmit="
			...
			<div class="col-md-6">
				<div class="mb-10 px-10">
					...
					<input type="password" name="new_password" id="password" placeholder="Nueva Contraseña aquí..." class="form-control">
				</div>
			</div>
			<div class="col-md-6">
				<div class="mb-10 px-10">
					<label class="form-label required">Confirmmar Contraseña</label>
					<input type="password" name="confirm_password" id="cpassword" placeholder="Confirmar contraseña aquí..." class="form-control">
				</div>
			</div>
			<div class="col-md-6">
				<div class="mb-10 px-10">
			...
			<div class="col-md-12">
				<div class="mb-10 px-10">
					<input type="submit" name="submit" value="Cambiar Contraseña" class="btn btn-sm btn-primary text-white">
				</div>
			</div>
		</form>
	</div>
