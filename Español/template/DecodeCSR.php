<div class="container-fluid">
	<div class="card py-0">
		<div class="d-flex justify-content-between align-items-center pt-15">
			<h5 class="m-0">Decodificar CSR</h5>
		...
		<hr>
			<div class="row pb-20">
				...
				<div class="col-md-6">
					<div class="mb-10 px-10">
						<label class="form-label required">Compañia</label>
				...
				<div class="col-md-12">
					<div class="mb-10 px-10">
						<label class="form-label required">Código CSR</label>
						<textarea name="csr" style="height: 250px" placeholder="Código CSR..." class="form-control" id="csr_code" required></textarea> 
					</div>
				</div>
				<div class="col-md-12">
					<div class="mb-5 px-10">
						<button name="submit" id="decode" class="btn btn-sm btn-primary">Decodificar</button>
					</div>
				</div>
