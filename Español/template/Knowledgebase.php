<div class="container-fluid">
	<div class="card py-0">
		<div class="d-flex justify-content-between align-items-center pt-15">
			...
			<a href="<?php echo $AreaInfo['area_url'];?>index.php" class="btn text-white btn-danger btn-sm"><i class="fa fa-backward"></i> Volver</a>
		</div>
		<hr>
			...
			<table class="table table-stripped">
				...
				?>
					<tr>
						...
						<td><a href="<?php echo $AreaInfo['area_url'];?>viewknowledgebase.php?knowledgebase_id=<?php echo $Knowledgebase['knowledgebase_id'];?>" class="btn btn-sm btn-secondary btn-rounded">Leer</a></td>
					</tr>
					<?php
							}
						} else {
		...
		<p class="pb-10"><?php echo $Rows;?> Knowledgebase encontradas</p>
	</div>
</div>
