<div class="container-fluid">
	<div class="card py-0">
		<div class="d-flex justify-content-between align-items-center pt-15">
			<h5 class="m-0">Inicio de sesión de cPanel</h5>
		...
		<div class="mb-15">
			<p>Ahora está siendo redireccionado al panel de control. Puede tomar hasta 5 segudnos depende de la velocidad de su internet.</p>
			...
			<input type="hidden" name="passwd" value="<?php echo $AccountInfo['account_password'];?>" alt="password">
				<div class="text-center">
					<input type="submit" name="Submit" value="Click aquí para er redireccionado" class="btn btn-primary btn-sm text-white">
				</div>
			</form>
		</div>
	</div>
