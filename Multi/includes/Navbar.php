      ...
      <nav class="navbar">
        <div class="container-fluid">
		    ...
		    <li class="nav-item nav-height dropdown with-arrow">
		      ...
		      <div class="dropdown-menu dropdown-menu-right" aria-labelledby="nav-link-dropdown-toggle">
		        <a href="<?php echo $AreaInfo['area_url'];?>myprofile.php" class="dropdown-item"><?php echo $text['my_porfile_title'];?></a>
		        <a href="<?php echo $AreaInfo['area_url'];?>mysettings.php" class="dropdown-item"><?php echo $text['my_settings_title'];?></a>
		        <a href="<?php echo $AreaInfo['area_url'];?>logout.php" class="dropdown-item"><?php echo $text['logout'];?></a>
		        <div class="dropdown-divider"></div>
		        <div class="dropdown-content">
		          <button class="btn btn-block" role="button" onclick="halfmoon.toggleDarkMode()"><i class="fa fa-sun"></i> Tema</button>
		        </div>
		      </div>
		    </li>
