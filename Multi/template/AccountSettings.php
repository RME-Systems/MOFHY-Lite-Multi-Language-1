<div class="container-fluid">
	<div class="card py-0">
		<div class="d-flex justify-content-between align-items-center pt-15">
			<h5 class="m-0"><?php echo $text['settings_title'];?></h5>
		...
		<div class="mb-15">
			...
			<form  action="function/DeactivateAccount.php" method="post" onsubmit="
					...
					if(reason.length<8){
						alert('<?php echo $text['desactivation_error'];?>');
						return false;
					}
					return true;
				">
				...
				<div class="mb-10 px-10">
					<label class="form-label required"><?php echo $text['desactivation_reason'];?></label>
					<textarea name="reason" placeholder="<?php echo $text['desactivation_reason_place'];?>" class="form-control" id="reason"></textarea>
					<input type="hidden" name="account_username" value="<?php echo $AccountInfo['account_username'];?>">
					<input type="hidden" name="account_key" value="<?php echo $AccountInfo['account_key'];?>">
				</div>
				<div class="mb-10 px-10">
