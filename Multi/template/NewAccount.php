<div class="container-fluid">
	<div class="card py-0">
		...
		<div class="row mb-10">
			...
			<div class="col-md-6">
				<div class="mb-10 px-10">
					<label class="form-label required"><?php echo $text['your_phone'];?></label>
					<input type="text" name="email" value="<?php echo $ClientInfo['hosting_client_phone'];?>" class="form-control disabled" readonly>
				</div>
			</div>
			<div class="col-md-6">
				<div class="mb-10 px-10">
					<label class="form-label required"><?php echo $text['your_address'];?></label>
		...
		<div class="col-md-12 mb-10">
			<div class="mb-10 px-10">
				<div class="tabs">
			        <button class="tab-item btn btn-sm" data-tab="SubDomain" id="DefaultClicked"><?php echo $text['subdomain_title'];?></button>
		        ...
		        <label class="form-label required"><?php echo $text['custom_domain'];?></label>
					<div class="input-group">
					  <input type="text" id="cudomain" class="form-control" placeholder="<?php echo $text['serach_place'];?>">
			      ...
			      <div id="SubDomain" class="tab-content">
					...
					<div class="input-group">
					  <input type="text" id="sudomain" class="form-control" placeholder="<?php echo $text['serach_place'];?>">
					  <div class="input-group-append">
		...
		<div class="col-md-12 mb-15">
			<form action="function/NewAccount.php" method="post">
				<div class="row">
					...
					<div class="col-md-6">
						<div class="mb-10 px-10">
							<label class="form-label required"><?php echo $text['domain'];?></label>
							<input type="text" name="domain" id="validomain" placeholder="<?php echo $text['domain_place'];?>" class="form-control disabled" readonly required="true">
						</div>
					</div>
					<div class="col-md-6">
						<div class="mb-10 px-10">
							<label class="form-label required"><?php echo $text['account_username'];?></label>
							<input type="text" name="username" placeholder="<?php echo $text['account_username_place'];?>" class="form-control disabled" readonly>
						</div>
					</div>
					<div class="col-md-6">
						<div class="mb-10 px-10">
							<label class="form-label required"><?php echo $text['account_pass'];?></label>
							<input type="password" name="password" placeholder="<?php echo $text['account_pass_place'];?>" class="form-control" required="true">
						</div>
					</div>
					<div class="col-md-6">
						<div class="mb-10 px-10">
							<button class="btn btn-primary btn-sm" name="submit"><?php echo $text['create_account'];?></button>
						</div>
					</div>
				</div>
			</form>
