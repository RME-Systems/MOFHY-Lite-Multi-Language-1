<div class="container-fluid">
	<div class="card p-15">
		<div class="d-flex justify-content-between align-items-center px-5">
			<h5 class="m-0"><?php echo $text['my_settings_title'];?></h5>
		  ...
		  <form action="function/MySettings.php" method="post">
			<div class="row">
				...
				<div class="col-md-6">
					<div class="mb-10 px-10">
						<label class="form-label required"><?php echo $text['country'];?></label>
						...
						array("name"=>"Zimbabwe", "code"=>"ZW")
							...
							foreach($Country as $State){
								...
								elseif($State['code']=='NULL'){
									echo '<option value="NULL" disabled="disabled" selected="selected">', $text['select_country'], '</option>';
								}
								else{
				...
				<div class="col-md-6">
					<div class="mb-10 px-10">
						<label class="form-label required"><?php echo $text['city'];?></label>
						<input type="text" name="city" value="<?php echo $ClientInfo['hosting_client_city'];?>" class="form-control" required>
					</div>
				</div>
				<div class="col-md-6">
					<div class="mb-10 px-10">
						<label class="form-label required"><?php echo $text['postal_code'];?></label>
						<input type="text" name="postal" value="<?php echo $ClientInfo['hosting_client_pcode'];?>" class="form-control" required>
					</div>
				</div>
				<div class="col-md-12">
					<div class="mb-10 px-10">
						<button name="submit" class="btn btn-sm btn-primary"><?php echo $text['update_porfile'];?></button>
		...
		<form class="row" action="function/MyPassword.php" method="post" onsubmit="
					...
					if(password != cpassword){
						alert('<?php echo $text['pass_confirm_error'];?>');
						return false;
					}
					return true;
				">
			<div class="col-md-6">
				<div class="mb-10 px-10">
					...
					<input type="password" name="new_password" id="password" placeholder="<?php echo $text['new_pass_place'];?>" class="form-control">
				</div>
			</div>
			<div class="col-md-6">
				<div class="mb-10 px-10">
					<label class="form-label required"><?php echo $text['confirm_pass'];?></label>
					<input type="password" name="confirm_password" id="cpassword" placeholder="<?php echo $text['confirm_pass_place'];?>" class="form-control">
				</div>
			</div>
			<div class="col-md-6">
				<div class="mb-10 px-10">
			...
			<div class="col-md-12">
				<div class="mb-10 px-10">
					<input type="submit" name="submit" value="<?php echo $text['change_pass'];?>" class="btn btn-sm btn-primary text-white">
				</div>
			</div>
		</form>
	</div>
