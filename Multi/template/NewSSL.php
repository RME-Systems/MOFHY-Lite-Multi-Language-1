<div class="container-fluid">
	<div class="card py-0">
		<div class="d-flex justify-content-between align-items-center pt-15">
			<h5 class="m-0"><?php echo $text['newssl_title'];?></h5>
		...
		<form action="function/NewSSL.php" method="post">
			<div class="row pb-20">
				...
				<div class="col-md-12">
					<div class="mb-10 px-10">
						<label class="form-label required"><?php echo $text['ssl_domain'];?></label>
						<input type="text" name="domain" placeholder="<?php echo $text['ssl_domain_place'];?>" class="form-control" required>
					</div>
				</div>
				<div class="col-md-12">
					<div class="mb-10 px-10">
